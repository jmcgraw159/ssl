...
$validationModel->checkRegister();
include 'views/captcha.php';
// $viewModel->getView("views/captcha.php");
?>
...
<div id="registration">
	...
	<form action="?action=adduser" method="post" enctype="multipart/form-data">
		...
		<input type="text" name="donate" placeholder="$0.00">
		<input type="checkbox" name="newsletter" checked><p>Subscribe to our weekly newsletter.</p>
		<input type="checkbox" name="tos" required><p>I have read and agree to the terms of service.</p>
		<img id="captcha" src="cap.png"/>
		<label for="#">Captcha:</label>
		<input type="text" name="captcha" placeholder="Enter the characters above">
